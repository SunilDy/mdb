...
export default async function handler(
    req: NextApiRequest,
    res: NextApiResponse<{error?: any, user?: User, status?: string, users?: User[], message?: string, likedMovies?: string[], result?: any, session?: any}>
) {
...
<<<<<<< HEAD
                    let result = await axios.get(`https://api.themoviedb.org/3/movie/${user.likedMovies[id]}?api_key=${process.env.NEXT_PUBLIC_API_KEY}&language=en-US`)
=======
