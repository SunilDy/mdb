  ...
  return (
    <div className="bg-primary border-2 border-primary">
      <Head>
        ...
        <meta
          name="description"
          content={`discover top-rated movies from the website having collection of all the movies released up to date`}
        />
      </Head>
      {/*Movies Section ========================================== */}
...
export const getServerSideProps = async (context: any) => {
  ...
  const res = await fetch(
    `https://api.themoviedb.org/3/movie/top_rated?api_key=${process.env.NEXT_PUBLIC_API_KEY}&page=${query.page}`
  );
